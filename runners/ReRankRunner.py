...
class ReRanker:
    ...
    def parse_args(parser):
        ...
        parser.add_argument("--base_reranker_path",
                            default="/data/yu12345/models/bge-reranker-base")
        parser.add_argument("--reranker_checkpoint",
                            default="bge-reranker-base/20250607-171746")

        parser.add_argument("--input_source", default="bge-base-en-v1.5_5")
        parser.add_argument("--input_file",
                            default="20250606-194643_user-6_20250529-092233")

        parser.add_argument("--model_name",
                            default="/data/yu12345/models/Qwen2-7B-Instruct")
